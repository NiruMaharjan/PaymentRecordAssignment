    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (enrollment != null) {
                ...
                int remainingAmount = paymentDAO.remainingAmount(enrollment.getId());
                ...
                if (remainingAmount != 0) {
                    ...
                    if (input.next().equalsIgnoreCase("y")) {
                        ...
                        remainingAmount = paymentDAO.remainingAmount(enrollment.getId());

                        System.out.println("Thank you for making a payment");
                    //System.out.println("enrollment_id"+enrollment.getId());

                        System.out.println("Your remaining amount is " + remainingAmount);
